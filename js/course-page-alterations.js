function updateCoursePageHeader() {
  var mainGroup = document.querySelector('.course__container')
  var defaultHeader = document.querySelector(
    '.header--student, .header--learner'
  )
  defaultHeader.remove()

  var newHeader = document.createElement('header')
  newHeader.className = 'pb-5 pt-0 bg-glacier-darkblue-600 md:pt-5'
  newHeader.innerHTML = `
        ...
        <nav class="flex items-center justify-between h-16 lg:h-20">
          ...
          >
            <a
              ...
              title="Dashboard"
              class="text-base flex items-center font-medium text-white transition-all duration-200 hover:text-blue-600 focus:text-blue-600"
            >
              Back to Dashboard
            </a>
          </button>
          ...
          <div class="hidden lg:flex lg:items-center lg:ml-auto lg:space-x-10">
            <a
              href="/learn/dashboard"
              title="Dashboard"
              class="text-base flex items-center font-medium text-white transition-all duration-200 hover:text-blue-600 focus:text-blue-600 gap-3"
            >
              <svg
                width="36"
                height="36"
...
function removeTopNavigationButtons() {
  var elements = document.querySelectorAll('.course__container .learner__content .directional__nav')
